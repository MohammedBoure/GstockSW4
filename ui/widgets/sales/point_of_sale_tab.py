...
class PointOfSaleTab(QWidget):
    ...
    def init_ui(self):
        self.setStyleSheet("""
            ...
            /* Frames for grouping sections */
            #CartFrame, #SummaryFrame {
            ...
            QTableWidget#POSCartTable {
                ...
                selection-background-color: #eef8ff;
            ...
            QTableWidget#POSCartTable::item:selected {
            ...
            /* Smaller inputs inside table */
            QTableWidget#POSCartTable QLineEdit,
            QTableWidget#POSCartTable QComboBox,
            QTableWidget#POSCartTable QDoubleSpinBox {
                padding: 6px 9px;
                font-size: 13px;
            ...
            QTableWidget#POSCartTable QComboBox::drop-down,
            QTableWidget#POSCartTable QDateEdit::drop-down {
                width: 22px;
                border: none;
                background: transparent;
            }
            QTableWidget#POSCartTable QComboBox::down-arrow,
            QTableWidget#POSCartTable QDateEdit::down-arrow {
                image: none;
                border: none;
                width: 0px;
                height: 0px;
            }
            QTableWidget#POSCartTable QAbstractSpinBox::up-button,
            QTableWidget#POSCartTable QAbstractSpinBox::down-button {
                width: 0px;
                border: none;
                background: transparent;
            }
            QTableWidget#POSCartTable QPushButton {
                padding: 0px;
                margin: 0px;
            }
